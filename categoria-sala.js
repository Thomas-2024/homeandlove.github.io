// Productos específicos de la categoría Sala de Estar
const salaProducts = [
    {
        id: 1,
...
let filteredProducts = [...salaProducts];
let currentPage = 1;
...
function applyFilters() {
    ...
    // Filtrar productos
    filteredProducts = salaProducts.filter(product => {
...
function addToCart(productId) {
    const product = salaProducts.find(p => p.id === productId);
